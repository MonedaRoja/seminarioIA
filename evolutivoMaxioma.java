    ...
    public class Genoma {  
        ...
        private List<Integer> genomaList=new ArrayList<Integer>();  // Almacenar secuencia génica  
        private Integer fitness;  // El valor de la función fitness  
        public List<INTEGER> getGenomaList() {  
            return genomaList;  
        }  
        public void setGenomaList(List<Integer> genomaList) {  
        ...
        public Genoma(List<Integer> genomaList, Integer fitness) {  
            super();  
            this.genomaList = genomaList;  
            this.fitness = fitness;  
        }  
    ...
    public class GAInicial {  
        ...
        public static void main(String[]args){  
            ...
            GeneticAlgorithm genAL=new MaxonGal(1100100101 , 0010000100 , 0000000000);  
